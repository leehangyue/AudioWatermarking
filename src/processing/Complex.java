...
public class Complex extends Object {
    ...
    */
    ...
    public Complex toComplex(double _x) {
    	return new Complex(_x, 0.0);
    }
    /**
    ...
    */
    ...
    public Complex times(double a) {//scaling
    ...
    */
    public Complex div(Complex w) {
        double den=Math.pow(w.real(), 2) + Math.pow(w.imag(), 2);
...
//	Please report any problems with this page to bennettmath.ksu.edu
